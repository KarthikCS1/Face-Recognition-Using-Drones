...
dan_image = face_recognition.load_image_file("str.jpeg")
dan_face_encoding = face_recognition.face_encodings(dan_image)[0]
dan_image = face_recognition.load_image_file("csk.jpeg")
csk_face_encoding = face_recognition.face_encodings(dan_image)[0]
